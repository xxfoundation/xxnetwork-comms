...
func (c *Comms) SendConfirmFact(host *connect.Host,
	message *pb.FactConfirmRequest) (*messages.Ack, error) {
	// Create the Send Function
	f := func(conn connect.Connection) (*any.Any, error) {
		// Set up the context
		ctx, cancel := host.GetMessagingContext()
...
// Client -> User Discovery Delete Fact Function
func (c *Comms) SendRemoveFact(host *connect.Host,
	message *pb.FactRemovalRequest) (*messages.Ack, error) {
	// Create the Send Function
	f := func(conn connect.Connection) (*any.Any, error) {
		// Set up the context
		ctx, cancel := host.GetMessagingContext()
...
// Client -> User Discovery Delete Fact Function
func (c *Comms) SendRemoveUser(host *connect.Host,
	message *pb.FactRemovalRequest) (*messages.Ack, error) {
	// Create the Send Function
	f := func(conn connect.Connection) (*any.Any, error) {
		// Set up the context
...
// SendUsernameValidation is a client to User Discovery send function. This will
// send a mixmessages.UsernameValidationRequest to UD, which UD will validate
// and send back a mixmessages.UsernameValidation.
