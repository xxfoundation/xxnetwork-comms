...
type Receiver func(*messages.GossipMsg) error

// Passed into NewGossip to specify how Gossip message signatures will be verified
type SignatureVerification func(*messages.GossipMsg, []byte) error
...
func (m *Manager) GRPCRegister(s *grpc.Server, gs *messages.GossipServer) {
}
