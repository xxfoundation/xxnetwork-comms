...
type NotificationRegisterRequest struct {
	...
	NotificationProvider  string `protobuf:"bytes,8,opt,name=NotificationProvider,proto3" json:"NotificationProvider,omitempty"`
}
...
func (x *NotificationRegisterRequest) GetNotificationProvider() string {
	if x != nil {
...
var file_mixmessages_proto_rawDesc = []byte{
	...
	0x6e, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52,
