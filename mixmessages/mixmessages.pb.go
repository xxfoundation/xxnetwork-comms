...
// Ack from public import gitlab.com/xx_network/comms/messages/messages.proto
type Ack = messages.Ack

// Ping from public import gitlab.com/xx_network/comms/messages/messages.proto
type Ping = messages.Ping

// AuthenticatedMessage from public import gitlab.com/xx_network/comms/messages/messages.proto
type AuthenticatedMessage = messages.AuthenticatedMessage

// ClientID from public import gitlab.com/xx_network/comms/messages/messages.proto
type ClientID = messages.ClientID

// AssignToken from public import gitlab.com/xx_network/comms/messages/messages.proto
type AssignToken = messages.AssignToken

// RSASignature from public import gitlab.com/xx_network/comms/messages/messages.proto
type RSASignature = messages.RSASignature
...
var fileDescriptor_f858aeec3eb2fbf5 = []byte{
	...
	,
}
