...
type ServerPollResponse struct {
	...
	PingRequest          *GatewayPingRequest `protobuf:"bytes,7,opt,name=PingRequest,proto3" json:"PingRequest,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
func (m *ServerPollResponse) GetPingRequest() *GatewayPingRequest {
	if m != nil {
...
// Information for a gateway to initiate
// gateway <-> gateway pings on a round
// Related to ReportGatewayPings
type GatewayPingRequest struct {
	RoundId              []byte   `protobuf:"bytes,1,opt,name=RoundId,proto3" json:"RoundId,omitempty"`
	GatewayIds           [][]byte `protobuf:"bytes,2,rep,name=GatewayIds,proto3" json:"GatewayIds,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *GatewayPingRequest) Reset()         { *m = GatewayPingRequest{} }
func (m *GatewayPingRequest) String() string { return proto.CompactTextString(m) }
...
func (m *GatewayPingRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GatewayPingRequest.Unmarshal(m, b)
}
func (m *GatewayPingRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GatewayPingRequest.Marshal(b, m, deterministic)
}
func (m *GatewayPingRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GatewayPingRequest.Merge(m, src)
}
func (m *GatewayPingRequest) XXX_Size() int {
	return xxx_messageInfo_GatewayPingRequest.Size(m)
}
func (m *GatewayPingRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_GatewayPingRequest.DiscardUnknown(m)
}

var xxx_messageInfo_GatewayPingRequest proto.InternalMessageInfo

func (m *GatewayPingRequest) GetRoundId() []byte {
	if m != nil {
		return m.RoundId
	}
	return nil
...
func (m *GatewayPingRequest) GetGatewayIds() [][]byte {
	if m != nil {
		return m.GatewayIds
	}
	return nil
...
// Returned results of a gateway ping request
type ReportedGatewayPings struct {
	RoundId              []byte   `protobuf:"bytes,1,opt,name=RoundId,proto3" json:"RoundId,omitempty"`
	GatewayIds           [][]byte `protobuf:"bytes,2,rep,name=GatewayIds,proto3" json:"GatewayIds,omitempty"`
	FailedGateways       [][]byte `protobuf:"bytes,3,rep,name=FailedGateways,proto3" json:"FailedGateways,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *ReportedGatewayPings) Reset()         { *m = ReportedGatewayPings{} }
func (m *ReportedGatewayPings) String() string { return proto.CompactTextString(m) }
func (*ReportedGatewayPings) ProtoMessage()    {}
func (*ReportedGatewayPings) Descriptor() ([]byte, []int) {
	return fileDescriptor_f858aeec3eb2fbf5, []int{10}
}

func (m *ReportedGatewayPings) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ReportedGatewayPings.Unmarshal(m, b)
}
func (m *ReportedGatewayPings) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ReportedGatewayPings.Marshal(b, m, deterministic)
}
func (m *ReportedGatewayPings) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ReportedGatewayPings.Merge(m, src)
}
func (m *ReportedGatewayPings) XXX_Size() int {
	return xxx_messageInfo_ReportedGatewayPings.Size(m)
}
func (m *ReportedGatewayPings) XXX_DiscardUnknown() {
	xxx_messageInfo_ReportedGatewayPings.DiscardUnknown(m)
}

var xxx_messageInfo_ReportedGatewayPings proto.InternalMessageInfo

func (m *ReportedGatewayPings) GetRoundId() []byte {
	if m != nil {
		return m.RoundId
	}
	return nil
...
func (m *ReportedGatewayPings) GetGatewayIds() [][]byte {
	if m != nil {
		return m.GatewayIds
	}
	return nil
...
func (m *ReportedGatewayPings) GetFailedGateways() [][]byte {
	if m != nil {
		return m.FailedGateways
	}
	return nil
}
...
// Response of a GatewayPing, reports it's own ID back to the sender
...
func (m *PingResponse) GetGatewayId() []byte {
	if m != nil {
		return m.GatewayId
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*GatewayPingRequest)(nil), "mixmessages.GatewayPingRequest")
	proto.RegisterType((*ReportedGatewayPings)(nil), "mixmessages.ReportedGatewayPings")
	proto.RegisterType((*SharePiece)(nil), "mixmessages.SharePiece")
	proto.RegisterType((*PingResponse)(nil), "mixmessages.PingResponse")
...
var fileDescriptor_f858aeec3eb2fbf5 = []byte{
	...
	,
}
...
type NodeClient interface {
	...
	ReportGatewayPings(ctx context.Context, in *messages.AuthenticatedMessage, opts ...grpc.CallOption) (*messages.Ack, error)
}
...
func (c *nodeClient) ReportGatewayPings(ctx context.Context, in *messages.AuthenticatedMessage, opts ...grpc.CallOption) (*messages.Ack, error) {
	out := new(messages.Ack)
	err := c.cc.Invoke(ctx, "/mixmessages.Node/ReportGatewayPings", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NodeServer interface {
	...
	// Gateway -> Server comm which reports the results of the gateway pinging
	// all other gateways in the round
	ReportGatewayPings(context.Context, *messages.AuthenticatedMessage) (*messages.Ack, error)
}
...
func (*UnimplementedNodeServer) ReportGatewayPings(ctx context.Context, req *messages.AuthenticatedMessage) (*messages.Ack, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReportGatewayPings not implemented")
}
...
func _Node_ReportGatewayPings_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(messages.AuthenticatedMessage)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NodeServer).ReportGatewayPings(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mixmessages.Node/ReportGatewayPings",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NodeServer).ReportGatewayPings(ctx, req.(*messages.AuthenticatedMessage))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Node_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ReportGatewayPings",
			Handler:    _Node_ReportGatewayPings_Handler,
		},
	},
...
type GatewayClient interface {
	...
	// to the sender
	GatewayPing(ctx context.Context, in *messages.AuthenticatedMessage, opts ...grpc.CallOption) (*PingResponse, error)
}
...
func (c *gatewayClient) GatewayPing(ctx context.Context, in *messages.AuthenticatedMessage, opts ...grpc.CallOption) (*PingResponse, error) {
	out := new(PingResponse)
	err := c.cc.Invoke(ctx, "/mixmessages.Gateway/GatewayPing", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GatewayServer interface {
	...
	// for arbitrary communication. Receiver returns it's own gateway ID
	// to the sender
	GatewayPing(context.Context, *messages.AuthenticatedMessage) (*PingResponse, error)
}
...
func (*UnimplementedGatewayServer) GatewayPing(ctx context.Context, req *messages.AuthenticatedMessage) (*PingResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GatewayPing not implemented")
}
...
func _Gateway_GatewayPing_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(messages.AuthenticatedMessage)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GatewayServer).GatewayPing(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mixmessages.Gateway/GatewayPing",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GatewayServer).GatewayPing(ctx, req.(*messages.AuthenticatedMessage))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Gateway_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GatewayPing",
			Handler:    _Gateway_GatewayPing_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "mixmessages.proto",
