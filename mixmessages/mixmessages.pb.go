...
func (*Contact) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{11} }
...
func (*ContactMessage) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{12} }
...
func (*RealtimeDecryptSlot) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{26} }
...
func (*RealtimeDecryptMessage) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{27} }
...
func (*RealtimeEncryptSlot) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{28} }
...
var fileDescriptor0 = []byte{
	...
	,
}
