...
// Holds information for a user requesting channel authentication from UD
type ChannelAuthenticationRequest struct {
	...
	UserSignedEdPubKey   []byte   `protobuf:"bytes,4,opt,name=UserSignedEdPubKey,proto3" json:"UserSignedEdPubKey,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *ChannelAuthenticationRequest) Reset()         { *m = ChannelAuthenticationRequest{} }
func (m *ChannelAuthenticationRequest) String() string { return proto.CompactTextString(m) }
func (*ChannelAuthenticationRequest) ProtoMessage()    {}
func (*ChannelAuthenticationRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_f858aeec3eb2fbf5, []int{51}
}

func (m *ChannelAuthenticationRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ChannelAuthenticationRequest.Unmarshal(m, b)
}
func (m *ChannelAuthenticationRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ChannelAuthenticationRequest.Marshal(b, m, deterministic)
}
func (m *ChannelAuthenticationRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ChannelAuthenticationRequest.Merge(m, src)
}
func (m *ChannelAuthenticationRequest) XXX_Size() int {
	return xxx_messageInfo_ChannelAuthenticationRequest.Size(m)
}
func (m *ChannelAuthenticationRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_ChannelAuthenticationRequest.DiscardUnknown(m)
}

var xxx_messageInfo_ChannelAuthenticationRequest proto.InternalMessageInfo

func (m *ChannelAuthenticationRequest) GetUserID() []byte {
	if m != nil {
		return m.UserID
	}
	return nil
...
func (m *ChannelAuthenticationRequest) GetUserEd25519PubKey() []byte {
	if m != nil {
...
func (m *ChannelAuthenticationRequest) GetTimestamp() int64 {
	if m != nil {
		return m.Timestamp
	}
	return 0
...
func (m *ChannelAuthenticationRequest) GetUserSignedEdPubKey() []byte {
	if m != nil {
		return m.UserSignedEdPubKey
	}
	return nil
}

// Contains UD response to a ChannelAuthenticationRequest, including lease & signature
type ChannelAuthenticationResponse struct {
	Lease                int64    `protobuf:"varint,1,opt,name=lease,proto3" json:"lease,omitempty"`
	UDSignedEdPubKey     []byte   `protobuf:"bytes,2,opt,name=UDSignedEdPubKey,proto3" json:"UDSignedEdPubKey,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *ChannelAuthenticationResponse) Reset()         { *m = ChannelAuthenticationResponse{} }
func (m *ChannelAuthenticationResponse) String() string { return proto.CompactTextString(m) }
func (*ChannelAuthenticationResponse) ProtoMessage()    {}
func (*ChannelAuthenticationResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f858aeec3eb2fbf5, []int{52}
}

func (m *ChannelAuthenticationResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ChannelAuthenticationResponse.Unmarshal(m, b)
}
func (m *ChannelAuthenticationResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ChannelAuthenticationResponse.Marshal(b, m, deterministic)
}
func (m *ChannelAuthenticationResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ChannelAuthenticationResponse.Merge(m, src)
}
func (m *ChannelAuthenticationResponse) XXX_Size() int {
	return xxx_messageInfo_ChannelAuthenticationResponse.Size(m)
}
func (m *ChannelAuthenticationResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_ChannelAuthenticationResponse.DiscardUnknown(m)
}

var xxx_messageInfo_ChannelAuthenticationResponse proto.InternalMessageInfo

func (m *ChannelAuthenticationResponse) GetLease() int64 {
	if m != nil {
		return m.Lease
	}
	return 0
...
func (m *ChannelAuthenticationResponse) GetUDSignedEdPubKey() []byte {
	if m != nil {
		return m.UDSignedEdPubKey
	}
	return nil
}
...
func init() {
	...
	proto.RegisterType((*ChannelAuthenticationRequest)(nil), "mixmessages.ChannelAuthenticationRequest")
	proto.RegisterType((*ChannelAuthenticationResponse)(nil), "mixmessages.ChannelAuthenticationResponse")
...
var fileDescriptor_f858aeec3eb2fbf5 = []byte{
	...
	,
	...
	,
}
...
type UDBClient interface {
	...
	RequestChannelAuthentication(ctx context.Context, in *ChannelAuthenticationRequest, opts ...grpc.CallOption) (*ChannelAuthenticationResponse, error)
}
...
func (c *uDBClient) RequestChannelAuthentication(ctx context.Context, in *ChannelAuthenticationRequest, opts ...grpc.CallOption) (*ChannelAuthenticationResponse, error) {
	out := new(ChannelAuthenticationResponse)
	err := c.cc.Invoke(ctx, "/mixmessages.UDB/RequestChannelAuthentication", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UDBServer interface {
	...
	// RequestChannelAuthentication requests a signature from UD on a user's ed25519 public key
	// Returning a lease and a signature from UD
	RequestChannelAuthentication(context.Context, *ChannelAuthenticationRequest) (*ChannelAuthenticationResponse, error)
}
...
func (*UnimplementedUDBServer) RequestChannelAuthentication(ctx context.Context, req *ChannelAuthenticationRequest) (*ChannelAuthenticationResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RequestChannelAuthentication not implemented")
}
...
func _UDB_RequestChannelAuthentication_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ChannelAuthenticationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UDBServer).RequestChannelAuthentication(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mixmessages.UDB/RequestChannelAuthentication",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UDBServer).RequestChannelAuthentication(ctx, req.(*ChannelAuthenticationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _UDB_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RequestChannelAuthentication",
			Handler:    _UDB_RequestChannelAuthentication_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "mixmessages.proto",
