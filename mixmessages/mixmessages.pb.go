...
var fileDescriptor_f858aeec3eb2fbf5 = []byte{
	...
	0x9c, 0xf2, 0x03, 0x72, 0xc8, 0xaf, 0xc8, 0x31, 0xa7, 0x5c, 0x7c, 0xc9, 0x39, 0x35, 0xaf, 0xdd,
	...
	,
}
...
type GatewayClient interface {
	...
	// to the sender
	GatewayPing(ctx context.Context, in *messages.Ping, opts ...grpc.CallOption) (*PingResponse, error)
}
...
func (c *gatewayClient) GatewayPing(ctx context.Context, in *messages.Ping, opts ...grpc.CallOption) (*PingResponse, error) {
...
type GatewayServer interface {
	...
	// for arbitrary communication. Receiver returns it's own gateway ID
	// to the sender
	GatewayPing(context.Context, *messages.Ping) (*PingResponse, error)
}
...
func (*UnimplementedGatewayServer) GatewayPing(ctx context.Context, req *messages.Ping) (*PingResponse, error) {
...
func _Gateway_GatewayPing_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GatewayServer).GatewayPing(ctx, req.(*messages.Ping))
	}
	return interceptor(ctx, in, info, handler)
}
