...
type MixMessageNodeClient interface {
	...
	UpsertUserBroadcast(ctx context.Context, in *UpsertUserMessage, opts ...grpc.CallOption) (*Ack, error)
}
...
func (c *mixMessageNodeClient) UpsertUserBroadcast(ctx context.Context, in *UpsertUserMessage, opts ...grpc.CallOption) (*Ack, error) {
	out := new(Ack)
	err := grpc.Invoke(ctx, "/mixmessages.MixMessageNode/UpsertUserBroadcast", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MixMessageNodeServer interface {
	...
	// Broadcasts user information to all other nodes
	UpsertUserBroadcast(context.Context, *UpsertUserMessage) (*Ack, error)
}
...
func _MixMessageNode_UpsertUserBroadcast_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpsertUserMessage)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MixMessageNodeServer).UpsertUserBroadcast(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mixmessages.MixMessageNode/UpsertUserBroadcast",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MixMessageNodeServer).UpsertUserBroadcast(ctx, req.(*UpsertUserMessage))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _MixMessageNode_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpsertUserBroadcast",
			Handler:    _MixMessageNode_UpsertUserBroadcast_Handler,
		},
	},
...
var fileDescriptor0 = []byte{
	...
	,
}
