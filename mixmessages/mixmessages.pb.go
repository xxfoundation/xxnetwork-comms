...
type NodeInfo struct {
	...
	ServerAddress        string   `protobuf:"bytes,3,opt,name=ServerAddress,json=serverAddress,proto3" json:"ServerAddress,omitempty"`
	GatewayAddress       string   `protobuf:"bytes,4,opt,name=GatewayAddress,json=gatewayAddress,proto3" json:"GatewayAddress,omitempty"`
	ServerTlsCert        string   `protobuf:"bytes,5,opt,name=ServerTlsCert,json=serverTlsCert,proto3" json:"ServerTlsCert,omitempty"`
	GatewayTlsCert       string   `protobuf:"bytes,6,opt,name=GatewayTlsCert,json=gatewayTlsCert,proto3" json:"GatewayTlsCert,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type NodeRegistration struct {
	...
	GatewayAddress       string   `protobuf:"bytes,4,opt,name=GatewayAddress,json=gatewayAddress,proto3" json:"GatewayAddress,omitempty"`
	RegistrationCode     string   `protobuf:"bytes,5,opt,name=RegistrationCode,json=registrationCode,proto3" json:"RegistrationCode,omitempty"`
	Port                 string   `protobuf:"bytes,6,opt,name=Port,json=port,proto3" json:"Port,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type UserRegistration struct {
	...
	ClientRSAPubKey      string   `protobuf:"bytes,2,opt,name=ClientRSAPubKey,json=clientRSAPubKey,proto3" json:"ClientRSAPubKey,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type UserRegistrationConfirmation struct {
	...
	ClientSignedByServer *RSASignature `protobuf:"bytes,1,opt,name=ClientSignedByServer,json=clientSignedByServer,proto3" json:"ClientSignedByServer,omitempty"`
...
type ClientVersionConfirmation struct {
	IsOK                 bool     `protobuf:"varint,1,opt,name=IsOK,json=isOK,proto3" json:"IsOK,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *ClientVersionConfirmation) Reset()         { *m = ClientVersionConfirmation{} }
func (m *ClientVersionConfirmation) String() string { return proto.CompactTextString(m) }
func (*ClientVersionConfirmation) ProtoMessage()    {}
func (*ClientVersionConfirmation) Descriptor() ([]byte, []int) {
	return fileDescriptor_f858aeec3eb2fbf5, []int{15}
}

func (m *ClientVersionConfirmation) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ClientVersionConfirmation.Unmarshal(m, b)
}
func (m *ClientVersionConfirmation) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ClientVersionConfirmation.Marshal(b, m, deterministic)
}
func (m *ClientVersionConfirmation) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ClientVersionConfirmation.Merge(m, src)
}
func (m *ClientVersionConfirmation) XXX_Size() int {
	return xxx_messageInfo_ClientVersionConfirmation.Size(m)
}
func (m *ClientVersionConfirmation) XXX_DiscardUnknown() {
	xxx_messageInfo_ClientVersionConfirmation.DiscardUnknown(m)
}

var xxx_messageInfo_ClientVersionConfirmation proto.InternalMessageInfo

func (m *ClientVersionConfirmation) GetIsOK() bool {
	if m != nil {
		return m.IsOK
	}
	return false
...
type NonceRequest struct {
	...
	ClientRSAPubKey      string        `protobuf:"bytes,2,opt,name=ClientRSAPubKey,json=clientRSAPubKey,proto3" json:"ClientRSAPubKey,omitempty"`
	ClientSignedByServer *RSASignature `protobuf:"bytes,3,opt,name=ClientSignedByServer,json=clientSignedByServer,proto3" json:"ClientSignedByServer,omitempty"`
	ClientDHPubKey       []byte        `protobuf:"bytes,4,opt,name=ClientDHPubKey,json=clientDHPubKey,proto3" json:"ClientDHPubKey,omitempty"`
	RequestSignature     *RSASignature `protobuf:"bytes,5,opt,name=RequestSignature,json=requestSignature,proto3" json:"RequestSignature,omitempty"`
	XXX_NoUnkeyedLiteral struct{}      `json:"-"`
	XXX_unrecognized     []byte        `json:"-"`
	XXX_sizecache        int32         `json:"-"`
}
...
type Nonce struct {
	...
	DHPubKey             []byte   `protobuf:"bytes,2,opt,name=DHPubKey,json=dHPubKey,proto3" json:"DHPubKey,omitempty"`
...
type RequestRegistrationConfirmation struct {
	...
	NonceSignedByClient  *RSASignature `protobuf:"bytes,2,opt,name=NonceSignedByClient,json=nonceSignedByClient,proto3" json:"NonceSignedByClient,omitempty"`
	Error                string        `protobuf:"bytes,3,opt,name=Error,json=error,proto3" json:"Error,omitempty"`
	XXX_NoUnkeyedLiteral struct{}      `json:"-"`
	XXX_unrecognized     []byte        `json:"-"`
	XXX_sizecache        int32         `json:"-"`
...
func init() {
	...
	proto.RegisterType((*ClientVersionConfirmation)(nil), "mixmessages.ClientVersionConfirmation")
...
var fileDescriptor_f858aeec3eb2fbf5 = []byte{
	...
	,
}
...
type RegistrationClient interface {
	...
	CheckClientVersion(ctx context.Context, in *ClientVersion, opts ...grpc.CallOption) (*ClientVersionConfirmation, error)
...
func (c *registrationClient) CheckClientVersion(ctx context.Context, in *ClientVersion, opts ...grpc.CallOption) (*ClientVersionConfirmation, error) {
	out := new(ClientVersionConfirmation)
	err := c.cc.Invoke(ctx, "/mixmessages.Registration/CheckClientVersion", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RegistrationServer interface {
	...
	// Client uses this to check if it needs to be updated
	CheckClientVersion(context.Context, *ClientVersion) (*ClientVersionConfirmation, error)
	//Node registration for the permissioning server
...
func (*UnimplementedRegistrationServer) CheckClientVersion(ctx context.Context, req *ClientVersion) (*ClientVersionConfirmation, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CheckClientVersion not implemented")
}
...
func _Registration_CheckClientVersion_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ClientVersion)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RegistrationServer).CheckClientVersion(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mixmessages.Registration/CheckClientVersion",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RegistrationServer).CheckClientVersion(ctx, req.(*ClientVersion))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Registration_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CheckClientVersion",
			Handler:    _Registration_CheckClientVersion_Handler,
		},
		{
