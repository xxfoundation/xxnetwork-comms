...
type Handler interface {
	...
	ConfirmNonce(message *pb.RSASignature) (*pb.
...
type implementationFunctions struct {
	...
	// Pass-through for Registration Nonce Confirmation
	ConfirmNonce func(message *pb.RSASignature) (*pb.
			RegistrationConfirmation, error)
}
...
func NewImplementation() Handler {
	...
	return Handler(&Implementation{
		Functions: implementationFunctions{
			...
			ConfirmNonce: func(message *pb.RSASignature) (*pb.RegistrationConfirmation, error) {
				warn(um)
...
// Pass-through for Registration Nonce Confirmation
func (s *Implementation) ConfirmNonce(message *pb.RSASignature) (*pb.
	RegistrationConfirmation, error) {
