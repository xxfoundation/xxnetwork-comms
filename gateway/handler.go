...
type Handler interface {
	...
	CheckMessages(userID *userid.UserID, messageID string) ([]string, bool)
...
type implementationFunctions struct {
	// Return any MessageIDs in the buffer for this UserID
	CheckMessages func(userID *userid.UserID, messageID string) ([]string, bool)
	// Returns the message matching the given parameters to the client
	GetMessage func(userID *userid.UserID, msgID string) (*pb.CmixMessage, bool)
	// Upload a message to the cMix Gateway
...
func NewImplementation() Handler {
	...
	return Handler(&Implementation{
		Functions: implementationFunctions{
			CheckMessages: func(userID *userid.UserID, messageID string) ([]string,
				bool) {
				warn(um)
				return nil, false
			},
			GetMessage: func(userID *userid.UserID, msgID string) (*pb.CmixMessage,
				bool) {
				warn(um)
...
// Return any MessageIDs in the buffer for this UserID
func (s *Implementation) CheckMessages(userID *userid.UserID, messageID string) (
	[]string, bool) {
	return s.Functions.CheckMessages(userID, messageID)
}

// Returns the message matching the given parameters to the client
func (s *Implementation) GetMessage(userID *userid.UserID, msgID string) (
	*pb.CmixMessage, bool) {
